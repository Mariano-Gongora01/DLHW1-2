...
data_dir = '/home/mgongora01/hw1_2/DLHW1-2/images/' 
...
layers.Dropout (0.2),
layers. Flatten(),
layers.Dense (128, activation='relu'), layers. Dense (64, activation='relu'), layers.Dense (16, activation='relu'), layers.Dense (3)
])# number of class
#callbacks = [EarlyStopping (monitor= 'val accuracy', patience=3)] [EarlyStopping(monitor='val_accuracy',
